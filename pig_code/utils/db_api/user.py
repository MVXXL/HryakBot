...
class User:
    ...
    def register(user_id):
        ...
        pig['genetic']['tail'] = random.choice(utils_config.default_pig_body_genetic)
        pig['genetic']['left_ear'] = random.choice(utils_config.default_pig_body_genetic)
        pig['genetic']['right_ear'] = random.choice(utils_config.default_pig_body_genetic)
        pig['genetic']['nose'] = random.choice(utils_config.default_pig_body_genetic)
        pig['genetic']['right_eye'] = random.choice(utils_config.default_pig_eyes_genetic)
        pig['genetic']['left_eye'] = random.choice(utils_config.default_pig_eyes_genetic)
        pig['genetic']['right_pupil'] = random.choice(utils_config.default_pig_pupils_genetic)
        pig['genetic']['left_pupil'] = random.choice(utils_config.default_pig_pupils_genetic)
